...
namespace Mediator.Examples
{
    ...
    class MainApp
    {
        static void Main()
        {
            ...
            ConcreteColleague3 c3 = new ConcreteColleague3(m); //сам третій челікс
    ...
    class ConcreteMediator : Mediator
    {
        ...
        private ConcreteColleague3 colleague3; // новий чел

        public ConcreteColleague1 Colleague1 { set { colleague1 = value; } }
        public ConcreteColleague2 Colleague2 { set { colleague2 = value; } }
        public ConcreteColleague3 Colleague3 { set { colleague3 = value; } } // статка нового чела
